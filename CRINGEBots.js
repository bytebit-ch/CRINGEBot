...
Client.on("message", function(message) {
    if(message.content === "-cringe toriel") {
	...
	if(message.content === "-cringe kiss") {
	...
	if(message.content === "-cringe mettaton") {
